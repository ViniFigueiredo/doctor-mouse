        ...
        <div class="login-box">
            <div class="logo" style="display: flex; align-items: center; gap: 8px;">
                ...
                <div class="logo-text" style="display: flex; flex-direction: column; justify-content: center;">
                    ...
                    <span class="logo-subtitle" style="font-family:'Inter', font-weight:400;">Gaming Store</span>
                </div>
            </div>
        <h2 style="text-align:center; font-weight:bold; font-family:'Roboto';">RECUPERAR SENHA</h2>

    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        <div class="mb-6">
            <nav class="flex items-center space-x-2 text-sm text-gray-500 mb-4">
                ...
                <span>/</span>
                <a href="{{ route('produtos.show', $produto) }}" class="hover:text-blue-600 transition-colors duration-200">
                    {{ $produto->nome }}
                </a>
                <span>/</span>
            ...
            <p class="text-gray-600 mt-2">Atualize as informações do produto abaixo</p>
        </div>
            ...
            <div>
                ...
                @if($produto->imagem)
                    <div class="mb-4 p-4 bg-gray-50 rounded-lg">
                        <p class="text-sm text-gray-600 mb-3">Imagem atual:</p>
                        <div class="flex items-center space-x-4">
                            ...
                            >
                            <div>
                                <p class="text-sm font-medium text-gray-900">{{ $produto->imagem }}</p>
                    ...
                    <div class="space-y-1 text-center" id="upload-content">
                        ...
                        <div class="flex text-sm text-gray-600">
                            <label for="imagem" class="relative cursor-pointer bg-white rounded-md font-medium text-blue-600 hover:text-blue-500 focus-within:outline-none focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-blue-500">
                                <span>{{ $produto->imagem ? 'Alterar imagem' : 'Upload uma imagem' }}</span>
                                <input 
                                    id="imagem" 
                                    name="imagem" 
                                    type="file" 
                        ...
                        <p class="text-xs text-gray-500">
                            PNG, JPG, GIF, SVG até 2MB{{ $produto->imagem ? ' (opcional)' : '' }}
                        </p>
                    </div>
